...
import { _gymSlotReducer } from './gym/state/reducers/gymSlot.reducer';
import { _gymReservationReducer } from './gym/state/reducers/gymReservation.reducer';
...
export interface AppState {
    ...
    gymSlot: DataStateGymSlot;
    gymReservation: DataStateGymReservation;
}
...
export interface DataStateGymSlot {
    gymSlot: any[];
    error?: string;
    loading: boolean;
}

export interface DataStateGymReservation {
    gymReservation: any[];
    error?: string;
    loading: boolean;
}
...
export const ROOT_APP_REDUCER: ActionReducerMap<AppState> = {
    ...
    gymSlot: _gymSlotReducer,
    gymReservation: _gymReservationReducer,
};
